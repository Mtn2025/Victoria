...
export const ToolsSettings = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            {/* Header section similar to others could be added here if needed, but keeping original structure */}
            ...
            >
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        />
                        <div>
                            <label className="text-[10px] uppercase text-slate-500 font-bold block mb-1">{t('tools.retry_error')}</label>
                            <Select
            ...
            <Accordion
                ...
                title={
                    <span className="text-sm font-bold text-amber-400 uppercase tracking-wider flex items-center gap-2">
                        ...
                        {t('tools.tab_schema')} & Client Tools
                    </span>
                }
            >
                <div className="space-y-4">
                    <div className="bg-slate-900 rounded-lg border border-slate-700 overflow-hidden">
                        <div className="bg-slate-800 px-3 py-2 flex justify-between items-center border-b border-slate-700">
                            <span className="text-xs font-mono text-amber-400">{t('tools.schema_filename')}</span>
                            <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center justify-between bg-slate-800/50 p-3 rounded-lg border border-slate-700">
                            <div>
                                <span className="text-xs font-bold text-slate-300 block">{t('tools.async_exec')}</span>
                                <span className="text-[10px] text-slate-500">{t('tools.async_desc')}</span>
                            </div>
                            <input
                                type="checkbox"
                        ...
                        <div className="flex items-center justify-between bg-blue-900/10 p-3 rounded-lg border border-blue-500/20">
                            <div>
                                <span className="text-xs font-bold text-blue-300 block">{t('tools.client_tools')}</span>
                                <span className="text-[10px] text-blue-400/60">{t('tools.client_tools_desc')}</span>
                            </div>
                            <input
                                type="checkbox"
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                            <h5 className="text-xs font-bold text-slate-300 mb-2">{t('tools.param_redac')}</h5>
                            <p className="text-[10px] text-slate-500 mb-2">{t('tools.param_redac_desc')}</p>
                            <textarea
                        ...
                        <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                            <h5 className="text-xs font-bold text-slate-300 mb-2">{t('tools.transfer_whitelist')}</h5>
                            <p className="text-[10px] text-slate-500 mb-2">{t('tools.transfer_whitelist_desc')}</p>
                            <textarea
                    ...
                    <div className="p-3 bg-indigo-900/20 rounded-lg border border-indigo-500/20 flex items-center justify-between">
                        <div className="flex gap-3 items-center">
                            ...
                            <div>
                                <span className="text-xs font-bold text-indigo-300 block">{t('tools.state_injection')}</span>
                                <span className="text-[10px] text-slate-400">{t('tools.state_injection_desc')}</span>
                            </div>
                        </div>
                        <input
                            type="checkbox"
